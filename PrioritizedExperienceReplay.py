...
class SumTree(object):
    ...
    def __init__(self, capacity):
        ...
        :param capacity: Experience Replay Size
        """
...
class PER(object):
    ...
    """
    PER_e = 0.01  # Hyper parameter that we use to avoid some experiences to have 0 probability of being taken
    PER_a = 0.6   # Trade-off between taking only exp with high priority and sampling randomly
    ...
    def __init__(self, capacity):
        ...
        We don't use deque because it means that at each step our experiences change index by one.
    ...
    def sample(self, n):
        """
        - First, to sample a minibatch of n size, the range [0, priority_total] is divided into n ranges.
        ...
        # Here, as explained in the paper, we divide the range [0, priority_total] into n ranges
